...
export default function Card({ ticketType, title, price, valuta, className, border, header, setCount2 }) {
  ...
  return (
    <div className="relative z-10 group rounded-xl inline-block p-[2px] overflow-hidden w-72 md:w-72 m-4 transition-transform hover:scale-105 shadow-lg">
      <span className={`${border || "default-class"} absolute inset-[-1000%] animate-[spin_7s_linear_infinite]`} />
      <div className="relative bg-gradient-to-tl from-customBlack to-customBlack_2 z-0 rounded-xl flex items-center justify-center">
        <div className={`${className} flex-col items-center rounded-xl inline-block p-2 overflow-hidden text-center`}>
          <h2 className={`${ceasarDressing.className} ${header || "default-class"}  text-3xl font-bold bg-gradient-to-r from-customPink via-customRed to-customOrange bg-clip-text text-transparent animate-gradient`}>{title}</h2>
          <div className="flex flex-col items-center justify-center ">
            ...
            <ul className="text-xs text-left mt-2 mb-6 list-disc text-gray-400">
              ...
              <li>
                <p>Meet-and-greet med artister</p>
              </li>
            </ul>
