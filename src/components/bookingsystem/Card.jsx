...
export default function Card({ formAction, ticketType, title, price, valuta, className, setCount2, getCount }) {
  ...
  return (
    <div className={`${className} text-foreground`}>
      ...
      <CounterInput getCount={getCount} setCountInTotal={setCountInTotal} name={ticketType === "single" ? "singleTickets" : "vipTickets"} max={10} count={count} setCount={updateCount} />
