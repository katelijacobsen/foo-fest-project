      ...
      <div className="w-full mt-4 md:mt-0 md:w-auto row-span-2 sm:col-span-2 place-self-end md:m-4">
        <button
          ...
          className={`w-full md:w-auto text-xl font-bold py-2 my-8 text-white ${
            totalTickets === 0
              ? "bg-gray-400 px-8 cursor-not-allowed rounded-sm"
              : "font-bold px-8 py-2 my-8 text-xl rounded-sm bg-gradient-to-bl from-customPink text-white to-customOrange"
          }`}
        >
          Næste
        </button>
