...
const LineupListReadMore = ({ initialLineup, artists }) => {
  ...
  return (
    <motion.section initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 1, delay: 0.5 }} animate={{ y: -40 }}>
      <section className="h-[80vh] md:h-screen place-content-center max-w-screen-xl mx-auto py-6 px-4 grid">
        <div className="pb-6">
