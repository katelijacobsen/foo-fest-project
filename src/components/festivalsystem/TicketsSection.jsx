  ...
  return (
    <section className="h-screen grid place-content-center px-4">
      <div className="grid gap-4  max-w-screen-xl mx-auto">
        ...
        <div>
          <p className="text-center text-2xl md:text-3xl md:max-w-[50rem]">På Foo Fest kan du vælge mellem en almindelig billet eller opgradere til en VIP-oplevelse, der giver dig den ultimative luksus og komfort under festivalen. Forkæl dig selv med noget ekstra og gør din festival uforglemmelig!</p>
        </div>
